...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Bulan Mei 2023 pada 07.12
...
(6, 116, '32', '1171', '1101020', 'Fajar ujung GG. Paweh No: 22', 28292, 4546432, 543245, '0', '2023-05-17 05:41:46', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `alamat_kategori`
--
...
--
-- Dumping data untuk tabel `alamat_kategori`
--
...
CREATE TABLE `feedback` (
  ...
  `foto_feedback` varchar(200) DEFAULT NULL,
...
INSERT INTO `feedback` (`id_feedback`, `id_user`, `id_order`, `id_teknisi`, `rating`, `ulasan`, `foto_feedback`, `create_at`, `point`) VALUES
(25, 116, 91, 72, 5, 'Mantap josssss bangetwdwdwd', 'foto_1683349815.jpg', '2023-05-06 07:10:15', 10),
(28, 116, 98, 72, 10, 'Mantap josssss banget kali coywdaw', 'foto_1684129116.png', '2023-05-15 07:38:36', 10),
(29, 116, 99, 72, 4, 'wefsdrfdcfdsc', 'foto_1684130244.jpg', '2023-05-15 07:57:24', 10),
(30, 116, 100, 73, 5, 'Mantap josssss banget kali coy', 'foto_1684137984.jpg', '2023-05-15 10:06:24', 10),
(31, 116, 100, 73, 10, 'mantap', 'foto_1684138089.jpg', '2023-05-15 10:08:09', 10),
(32, 116, 100, 73, 10, 'wadsxzsdccs', 'foto_1684138206.jpg', '2023-05-15 10:10:06', 10),
(33, 116, 101, 72, 10, 'Mantap josssss', 'foto_1684139189.jpg', '2023-05-15 10:26:29', 10);

-- --------------------------------------------------------

--
-- Struktur dari tabel `foto_feedback`
--
...
(12, 98, 72, 150000, '2023-05-15 07:36:19'),
(13, 100, 73, 200000, '2023-05-15 10:32:14'),
(14, 101, 72, 8999999, '2023-05-15 10:32:53');
...
(9, 12, 'Service AC', 'awdwadwa', 150000, NULL, '2023-05-15 07:36:19'),
(10, 13, 'Invoice', 'Barang Murah', 200000, NULL, '2023-05-15 10:32:14'),
(11, 14, 'Invocie', 'Mantao', 8999999, NULL, '2023-05-15 10:32:53');

-- --------------------------------------------------------

--
-- Struktur dari tabel `kondisi_ac`
--
...
--
-- Dumping data untuk tabel `kondisi_ac`
--

INSERT INTO `kondisi_ac` (`id`, `nama`) VALUES
(2, 'Panas'),
(3, 'Kotor'),
(4, 'Tidak Dingin'),
(5, 'Bunyi Keras'),
...
--
-- Struktur dari tabel `kondis_acorder`
--

CREATE TABLE `kondis_acorder` (
...
--
-- Dumping data untuk tabel `kondis_acorder`
--

INSERT INTO `kondis_acorder` (`id`, `id_order`, `kondisi`) VALUES
(13, 100, 'Panas'),
(14, 101, 'Kotor'),
(15, 102, 'Panas'),
(16, 102, 'Kotor'),
...
--
-- Dumping data untuk tabel `merk_ac`
--
...
--
-- Struktur dari tabel `notifikasi_order`
--
...
--
-- Dumping data untuk tabel `notifikasi_order`
--

INSERT INTO `notifikasi_order` (`id`, `id_order`, `jenis_layanan`, `judul`, `keterangan`, `create_at`) VALUES
(12, 100, '1', 'dipesan', 'Orderan', '2023-05-15 07:56:54'),
(13, 101, '1', 'dipesan', 'Orderan', '2023-05-15 07:57:12'),
(14, 102, '1', 'dipesan', 'Orderan', '2023-05-15 10:58:54');

-- --------------------------------------------------------

--
-- Struktur dari tabel `notifikasi_point`
--
...
--
-- Dumping data untuk tabel `notifikasi_point`
--

INSERT INTO `notifikasi_point` (`id`, `id_order`, `id_user`, `jumlah_point`, `judul`, `keterangan`, `create_at`) VALUES
(8, 100, 116, 100, 'diterima', 'Point', '2023-05-15 07:59:04'),
(9, 101, 116, 100, 'diterima', 'Point', '2023-05-15 08:02:39');

-- --------------------------------------------------------

--
-- Struktur dari tabel `order_display`
--
...
CREATE TABLE `order_display` (
  ...
  `type_ac` varchar(50) DEFAULT NULL,
  `alamat` varchar(50) DEFAULT NULL,
  `jadwal_pengerjaan` date DEFAULT NULL,
  `status` enum('dipesan','diterima','cancel','selesai') DEFAULT NULL,
...
--
-- Dumping data untuk tabel `order_display`
--
...
(100, 116, 10, '1', 'awdw3fesd', '1', 1, '23232', '5', '2023-06-29', 'selesai', '2023-05-15 07:56:54', 73, NULL),
(101, 116, 10, '1', '2q2e', '2', 2, '213123', '4', '2023-05-28', 'selesai', '2023-05-15 07:57:12', 72, NULL),
(102, 116, 5, '1', 'Ac Sangat Panas', '-', 1, '987768864', '4', '2023-05-16', 'dipesan', '2023-05-15 10:58:54', NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `order_histori`
--
...
--
-- Dumping data untuk tabel `order_histori`
--
...
(115, 116, 85, 72, 1, '2023-05-05 06:17:21', 'selesai'),
(116, 116, 88, NULL, 1, '2023-05-06 06:33:59', 'Dibatalkan'),
(117, 116, 88, NULL, 1, '2023-05-06 06:34:11', 'Dibatalkan'),
(118, 116, 88, NULL, 1, '2023-05-06 06:34:48', 'Dibatalkan'),
(119, 116, 88, NULL, 1, '2023-05-06 06:36:13', 'Dibatalkan'),
(120, 116, 89, 72, 1, '2023-05-06 07:03:53', 'selesai'),
(121, 116, 87, NULL, 2, '2023-05-06 07:04:16', 'Dibatalkan'),
(124, 116, 91, 72, 1, '2023-05-06 07:10:05', 'selesai'),
(131, 116, 98, 72, 1, '2023-05-15 07:38:24', 'selesai'),
(132, 116, 99, 72, 1, '2023-05-15 07:57:16', 'selesai'),
(133, 116, 100, 73, 1, '2023-05-15 10:06:18', 'selesai'),
(134, 116, 100, 73, 1, '2023-05-15 10:08:01', 'selesai'),
(135, 116, 100, 73, 1, '2023-05-15 10:10:00', 'selesai'),
(136, 116, 101, 72, 1, '2023-05-15 10:26:23', 'selesai');

-- --------------------------------------------------------

--
-- Struktur dari tabel `order_kondisi`
--
...
(30, 116, 'amie', 2147483647, 'amie@email.com', 130, '10', 'foto_1679023697.png', '2023-03-17 04:28:17', 893534),
(31, 118, 'feni', 2147483647, 'abwd@dnwad.ceef', 0, '10', 'foto_1684122617.jpg', '2023-05-15 05:50:17', 687095);
...
(5, 117, 1000, '2023-05-04 07:29:29'),
(6, 117, 100, '2023-05-05 05:48:36'),
(7, 116, 10, '2023-05-05 06:17:27'),
(8, 117, 100, '2023-05-06 06:36:56'),
(9, 116, 10, '2023-05-06 07:03:57'),
(10, 117, 100, '2023-05-06 07:05:02'),
(11, 116, 10, '2023-05-06 07:06:28'),
(12, 117, 100, '2023-05-06 07:09:54'),
(13, 116, 10, '2023-05-06 07:10:15'),
(14, 116, 10, '2023-05-15 07:04:11'),
(15, 117, 100, '2023-05-15 07:05:51'),
(16, 116, 10, '2023-05-15 07:07:38'),
(17, 117, 100, '2023-05-15 07:34:22'),
(18, 117, 100, '2023-05-15 07:34:26'),
(19, 116, 10, '2023-05-15 07:38:36'),
(20, 116, 10, '2023-05-15 07:57:24'),
(21, 119, 100, '2023-05-15 07:59:04'),
(22, 117, 100, '2023-05-15 08:02:39'),
(23, 116, 10, '2023-05-15 10:06:24'),
(24, 116, 10, '2023-05-15 10:08:09'),
(25, 116, 10, '2023-05-15 10:10:06'),
(26, 116, 10, '2023-05-15 10:26:29');

-- --------------------------------------------------------

--
-- Struktur dari tabel `point_konversi`
--
...
--
-- Dumping data untuk tabel `point_konversi`
--
...
(6, 1000, 10000000, '2023-05-04 06:58:07');

-- --------------------------------------------------------

--
-- Struktur dari tabel `point_master`
--
...
--
-- Dumping data untuk tabel `point_master`
--
...
CREATE TABLE `tb_kecamatan` (
  `id` int(11) NOT NULL,
  `id_kota_kabupaten` int(4) DEFAULT NULL,
...
INSERT INTO `tb_kecamatan` (`id`, `id_kota_kabupaten`, `nama`) VALUES
...
INSERT INTO `tb_kota_kabupaten` (`id`, `id_provinsi`, `nama`) VALUES
...
(72, 117, 'teknisi', 2147483647, 'Padang', '2023-03-16', 2147483647, 'Jalan jalan', 'teknisi@email.com', 'cv_1679038405.png', '56768775687897', '10', 1050, 'foto_1679038405.png', '2023-03-17 08:32:38'),
(73, 119, 'teknisi1', 2147483647, 'gjhbndmneds', '2023-05-30', 2147483647, 'Fajar ujung GG. Paweh No: 22', 'habibalfrz07@gmail.com', 'cv_1684130324.jpg', '432243324', '10', -100, 'foto_1684130324.jpg', '2023-05-15 07:58:01');
...
(118, 'feni123', 'aGEOcTYi3O-A5VI2NuK7CzxLaY31atWl', '$2y$13$C1T2/RgnmxEGTisO6lGw1usr6Hack7YHV457SQ/ae1d/tl0.zgFR6', NULL, 'abwd@dnwad.ceef', 10, 1684122617, 1684122617, 'Kuea-INkOM3BR1FMVMQK9ZDsx9pl99wB_1684122617', 'customer'),
(119, 'teknisi1', '_eQFzKDOVG_Cf4fXHHV4XjObDD3_iwtD', '$2y$13$NTPHix.bQNsc6aGglQdax.y.V2tAZNZWWYV/Q7bF5vsLwcLiQ/Ucq', NULL, 'habibalfrz07@gmail.com', 10, 1684130324, 1684130324, 'SJWvlMz48KC_S34phGodUv0oX7YHhLVQ_1684130324', 'teknisi');
...
--
-- Indeks untuk tabel `alamat_kategori`
--
...
--
-- Indeks untuk tabel `foto_feedback`
--
...
--
-- Indeks untuk tabel `kondisi_ac`
--
ALTER TABLE `kondisi_ac`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `kondis_acorder`
--
ALTER TABLE `kondis_acorder`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_order` (`id_order`);
...
--
-- Indeks untuk tabel `notifikasi_order`
--
ALTER TABLE `notifikasi_order`
  ADD PRIMARY KEY (`id`),
  ADD KEY `notifikasi_order_ibfk_1` (`id_order`);

--
-- Indeks untuk tabel `notifikasi_point`
--
...
--
-- Indeks untuk tabel `order_display`
--
...
--
-- Indeks untuk tabel `order_histori`
--
...
--
-- Indeks untuk tabel `order_kondisi`
--
...
--
-- Indeks untuk tabel `point_konversi`
--
ALTER TABLE `point_konversi`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `point_master`
--
...
--
-- AUTO_INCREMENT untuk tabel `alamat_kategori`
--
ALTER TABLE `alamat_kategori`
...
--
ALTER TABLE `feedback`
  MODIFY `id_feedback` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT untuk tabel `foto_feedback`
--
ALTER TABLE `foto_feedback`
...
--
-- AUTO_INCREMENT untuk tabel `kondisi_ac`
--
ALTER TABLE `kondisi_ac`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `kondis_acorder`
--
ALTER TABLE `kondis_acorder`
...
--
-- AUTO_INCREMENT untuk tabel `merk_ac`
--
ALTER TABLE `merk_ac`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `notifikasi_order`
--
ALTER TABLE `notifikasi_order`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `notifikasi_point`
--
ALTER TABLE `notifikasi_point`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `order_display`
--
ALTER TABLE `order_display`
  MODIFY `id_order` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT untuk tabel `order_histori`
--
ALTER TABLE `order_histori`
  MODIFY `id_historis` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT untuk tabel `order_kondisi`
--
ALTER TABLE `order_kondisi`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pelanggan`
  MODIFY `id_pelanggan` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
-- AUTO_INCREMENT untuk tabel `point_konversi`
--
ALTER TABLE `point_konversi`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `point_master`
--
ALTER TABLE `point_master`
  MODIFY `id_point` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `teknisi`
--
ALTER TABLE `teknisi`
  MODIFY `id_teknisi` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT untuk tabel `topup`
--
ALTER TABLE `topup`
  MODIFY `id_topup` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
-- Ketidakleluasaan untuk tabel `foto_feedback`
--
ALTER TABLE `foto_feedback`
...
--
-- Ketidakleluasaan untuk tabel `kondis_acorder`
--
ALTER TABLE `kondis_acorder`
  ADD CONSTRAINT `kondis_acorder_ibfk_1` FOREIGN KEY (`id_order`) REFERENCES `order_display` (`id_order`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `notifikasi_order`
--
ALTER TABLE `notifikasi_order`
  ADD CONSTRAINT `notifikasi_order_ibfk_1` FOREIGN KEY (`id_order`) REFERENCES `order_display` (`id_order`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `notifikasi_point`
--
ALTER TABLE `notifikasi_point`
...
--
-- Ketidakleluasaan untuk tabel `order_display`
--
ALTER TABLE `order_display`
...
--
ALTER TABLE `tb_kecamatan`
  ADD CONSTRAINT `tb_kecamatan_ibfk_1` FOREIGN KEY (`id_kota_kabupaten`) REFERENCES `tb_kota_kabupaten` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_kota_kabupaten`
--
ALTER TABLE `tb_kota_kabupaten`
  ADD CONSTRAINT `tb_kota_kabupaten_ibfk_1` FOREIGN KEY (`id_provinsi`) REFERENCES `tb_provinsi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
